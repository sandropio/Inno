 ...
 */
    fixed.exec = function (str) {
        ...
        if (match) {
            ...
            if (this.global && !match[0].length && (this.lastIndex > match.base)) {
                this.lastIndex = match.base;
            }
        }
        if (!this.global) {
...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode category. Addon fullcalendar for other Unicode
 ...
 */
    XRegExp.addUnicodePackage = function (pack, aliases) {
        ...
        if (!XRegExp.isInstalled("extensibility")) {
            throw new Error("extensibility must be installed before adding Unicode fullcalendar");
        }
        if (pack) {
            for (p in pack) {
...
/* Adds data for the Unicode `Letter` category. Addon fullcalendar include other categories, scripts,
